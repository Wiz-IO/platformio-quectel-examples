...
{
  if (uart_init(dev_path) != UART_SUCCESS)
    return OW_ERR_UART;
  else
...
#ifdef DS_DEBUG
  //printf("DS_DEBUG: Probe result: 0x%02hx\n", err);
#endif
...
#ifdef DS_DEBUG
  //printf("DS_DEBUG: Write char:   0x%02hx\n", b);
#endif
...
#ifdef DS_DEBUG
  //printf("DS_DEBUG: Write result: 0x%02hx\n", b);
#endif
