...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_ReportPropertyAsync(DIGITALTWIN_INTERFACE_CLIENT_HANDLE interfaceHandle,DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle, const char* propertyName, const char* propertyData)
{
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportManufacturer(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    ...
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle,digitalTwinDeviceClientHandle, DeviceinfoInterface_ManufacturerProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportModel(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    if (appState.interfaceClientHandle == NULL)
    {
        LogError("DEVICEINFO_INTERFACE: interfaceClientHandle is required to be initialized before reporting properties");
    ...
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle,digitalTwinDeviceClientHandle, DeviceinfoInterface_ModelProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportSwVersion(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    if (appState.interfaceClientHandle == NULL)
    {
        LogError("DEVICEINFO_INTERFACE: interfaceClientHandle is required to be initialized before reporting properties");
    ...
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle,digitalTwinDeviceClientHandle, DeviceinfoInterface_SwVersionProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportOsName(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    if (appState.interfaceClientHandle == NULL)
    {
        LogError("DEVICEINFO_INTERFACE: interfaceClientHandle is required to be initialized before reporting properties");
    ...
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle,digitalTwinDeviceClientHandle, DeviceinfoInterface_OsNameProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportProcessorArchitecture(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    if (appState.interfaceClientHandle == NULL)
    {
        LogError("DEVICEINFO_INTERFACE: interfaceClientHandle is required to be initialized before reporting properties");
    ...
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle,digitalTwinDeviceClientHandle, DeviceinfoInterface_ProcessorArchitectureProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportProcessorManufacturer(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    if (appState.interfaceClientHandle == NULL)
    {
        LogError("DEVICEINFO_INTERFACE: interfaceClientHandle is required to be initialized before reporting properties");
    ...
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle,digitalTwinDeviceClientHandle, DeviceinfoInterface_ProcessorManufacturerProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportTotalStorage(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    if (appState.interfaceClientHandle == NULL)
    {
        LogError("DEVICEINFO_INTERFACE: interfaceClientHandle is required to be initialized before reporting properties");
    ...
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle,digitalTwinDeviceClientHandle,DeviceinfoInterface_TotalStorageProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportTotalMemory(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    if (appState.interfaceClientHandle == NULL)
    {
        LogError("DEVICEINFO_INTERFACE: interfaceClientHandle is required to be initialized before reporting properties");
    ...
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, digitalTwinDeviceClientHandle,DeviceinfoInterface_TotalMemoryProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportAll(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE digitalTwinDeviceClientHandle)
{
    ...
    if (((result = DeviceinfoInterface_Property_ReportManufacturer(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK) ||
        ((result = DeviceinfoInterface_Property_ReportModel(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK) ||
        ((result = DeviceinfoInterface_Property_ReportSwVersion(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK) ||
        ((result = DeviceinfoInterface_Property_ReportOsName(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK) ||
        ((result = DeviceinfoInterface_Property_ReportProcessorArchitecture(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK) ||
        ((result = DeviceinfoInterface_Property_ReportProcessorManufacturer(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK) ||
        ((result = DeviceinfoInterface_Property_ReportTotalStorage(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK) ||
        ((result = DeviceinfoInterface_Property_ReportTotalMemory(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK) )
    //if ((result = DeviceinfoInterface_Property_ReportManufacturer(digitalTwinDeviceClientHandle)) != DIGITALTWIN_CLIENT_OK)
...
DIGITALTWIN_INTERFACE_CLIENT_HANDLE DeviceinfoInterface_Create()
{
    ...
    else
    {
		...
		//LogInfo("/r/ndeviceinfo.interfaceClientHandle=%d/r/n",interfaceHandle);
    }
